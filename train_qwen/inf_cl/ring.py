# Some code in this file is referenced from: Inf-CLIP
# Project Name: DAMO-NLP-SG/Inf-CLIP
# Author: https://github.com/DAMO-NLP-SG (Language Technology Lab at Alibaba DAMO Academy)
# Repository Address: https://github.com/DAMO-NLP-SG/Inf-CLIP
# License Agreement: Apache 2.0
# Original File: https://github.com/DAMO-NLP-SG/Inf-CLIP/blob/main/inf_cl/ring.py
...
def cal_inf_loss(q, k, labels=None, scale=None, head_dim=256):
    ...
    if scale is None:
        ...
        scale = GradientGather.apply(scale)
    if torch.distributed.is_initialized():
        return _cal_inf_loss(scale * q, k, labels, head_dim)
    else:
